...
public class RunningTaskTableModel extends AbstractTableModel {
    public final List<Integer> width = asList(15, 100, 200, 32, 50);
    ...
    private String[] columnNames = new String[]
            {"<html><b>Seq.", "<html><b>Task", "<html><b>Activity", "<html><b>Status", "<html><b>Completed"};
    private Class[] columnClasses = new Class[]
            {Integer.class, String.class, String.class, RunStatus.class, Integer.class};
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            ...
            case 2:
                return th.getActivity();
            case 3:
                return th.getRunStatus();
            case 4:
                return th.getProgress();
        }
