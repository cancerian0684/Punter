...
import com.sapient.kb.test.TestEditor;
...
public class HTMLEditor extends JPanel {
	...
	void jbInit() throws Exception {
		...
		/* KEY ACTIONS */
		 ...
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, KeyEvent.SHIFT_MASK),breakAction);
...
//		editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_S, KeyEvent.CTRL_MASK), saveAction);
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_B, KeyEvent.CTRL_MASK), boldAction);
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_I, KeyEvent.CTRL_MASK), italicAction); 
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_U, KeyEvent.CTRL_MASK), underAction);
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_Z, KeyEvent.CTRL_MASK), undoAction);
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_Z, KeyEvent.CTRL_MASK +KeyEvent.SHIFT_MASK), redoAction);
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, KeyEvent.CTRL_MASK +KeyEvent.SHIFT_MASK), insertTableCellAction);
		 editor.getKeymap().addActionForKeyStroke(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, KeyEvent.CTRL_MASK),insertTableRowAction);
	...
	public void registerSavAble(TestEditor testEditor) {
