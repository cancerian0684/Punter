...
public class AttachmentTableModel extends AbstractTableModel {
    ...
    private String[] columnNames = new String[]
            {"<html><b>ID", "<html><b>Attachment File", "<html><b>Size", "<html><b>Updated"};
    private Class[] columnClasses = new Class[]
            {Integer.class, String.class, Long.class, Date.class};
    ...
    public Object getValueAt(int row, int col) {
        ArrayList<?> colArrayList = (ArrayList<Object>) data.get(row);
        Attachment th = (Attachment) colArrayList.get(0);
        switch (col) {
            case 0:
                return th.getId();
            case 1:
