...
public class HttpUploadTask extends Tasks {
    ...
    public boolean run() {
        ...
        try {
            ...
            fileDownloadPath="http://"+StaticDaoFacade.getInstance().getServerHostAddress().getHostAddress()+":"+StaticDaoFacade.getInstance().getWebServerPort()+"/uploads/"+file.getName();
        } catch (Exception e) {
