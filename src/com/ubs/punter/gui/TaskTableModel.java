...
public class TaskTableModel extends AbstractTableModel {
	public final Object[] longValues = {new Integer(5), "Kathy123",new Integer(5), "None of the above"};
	...
	private String [] columnNames = new String [] 
                                  {"<html><b>Task Id","<html><b>Task Class","<html><b>Sequence","<html><b>Description"};
